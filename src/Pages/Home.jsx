  ...
  return (
    <div className="z-10">
      ...
      <div className="relative mx-auto w-11/12 mt-14 max-w-maxContent text-white flex flex-col justify-center items-center">
        ...
        <Link to={"/signUp"}>
          <div
            className="rounded-full max-auto mt-16 bg-richblack-800 py-[14px] px-[2.8rem]
          ...
          >
            <div className="p-[6px, 18px, 6px, 18px] flex flex-row gap-[8px] items-center">
              <p className="text-[#999DAA] font-inter font-bold">
        ...
        <div className="mx-3 my-12 shadow-lg shadow-blue-200 ">
          {/* muted – video ka sound off rahega (user ko kuch sunai nahi dega)
           loop – video khatam hone ke baad dobara chal jayega 
           autoPlay – video automatically start ho jayega page load hote hi */}
      ...
      <div className="bg-pure-greys-5 text-richblack-700 ">
        ...
        <div className="w-11/12 max-w-maxContent mt-32 flex flex-col lg:flex-row gap-x-[11rem] gap-y-4 justify-center mx-auto">
          ...
          <div className="flex flex-col gap-y-10 ">
            <div className="text-richblack-700 text-md">
